    ...
    <div className="space-y-6 md:space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-slate-100 tracking-tight">Purchase Orders</h1>
        </div>
      ...
      <Card className="p-0 overflow-hidden">
        {loading ? <div className="p-8 text-center text-slate-400 animate-pulse">Loading purchase orders...</div> : <Table columns={columns} data={orders} />}
      </Card>
    </div>
  );
}
